...
module TChart
  describe TeXGenerator, "generate" do
    before do
      @settings = stub( :x_label_width => 10, :y_label_width => 20, :line_height => 10 )
      label1 = stub( :date => Date.new(2000,1,1), :x_coordinate => 0, y_coordinate: -10, y_length: 30 )
      label2 = stub( :date => Date.new(2001,1,1), :x_coordinate => 100, y_coordinate: -10, y_length: 30 )
