...
module TChart  
  describe XLabelsBuilder, "build" do
    ...
    it "builds labels with the correct x-coordinate" do
      @x_axis_labels[0].label.coord.x.must_equal 0
      @x_axis_labels[1].label.coord.x.must_equal 25
      @x_axis_labels[2].label.coord.x.must_equal 50
      @x_axis_labels[3].label.coord.x.must_equal 75
      @x_axis_labels[4].label.coord.x.must_equal 100
    end
  end
