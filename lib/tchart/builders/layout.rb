module TChart
  class Layout
    ...
    def x_axis_dates
      @x_axis_dates ||= calc_x_axis_dates
    end
    
    # TODO: rename _label_ to something else (_tick_?)
    def x_axis_label_x_coordinates
      @x_axis_label_x_coordinates ||= calc_x_axis_label_x_coordinates
    end
    ...
    # TODO: rename to y_axis_item_y_coordinates to be consistent with x_axis_label_x_coordinates?
  ...
  private
    ...
    def calc_x_axis_label_x_coordinates
